...
//
//     final salatTimeModel = salatTimeModelFromJson(jsonString);

import 'dart:convert';

SalatTimeModel salatTimeModelFromJson(String str) => SalatTimeModel.fromJson(json.decode(str));

String salatTimeModelToJson(SalatTimeModel data) => json.encode(data.toJson());

class SalatTimeModel {
  int code;
  String status;
  List<Datum> data;
  ...
  factory SalatTimeModel.fromJson(Map<String, dynamic> json) => SalatTimeModel(
    code: json["code"],
    status: json["status"],
